        ...
        <div class="content-wrapper">
          <div class="content">
            ...
            <div class="container">
              ...
              <p>例如：在[35]格投出3点，则会前进1格到[36]格，然后在后退2格至[34]格，知道解锁终点超级宝藏。
              </p>
              <p>
                三、每天获取的骰子会参与[投资之神]排行榜的竞争，每天0点，<span>根据玩家前一日获取的骰子数量排行，</span>前15名玩家可以获得丰厚的奖励，奖励自动发放，可在个人中心查看获奖记录。
              </p>
              <p>
              ...
              <p>五、流水计入活动的游戏包括：欢乐竞技台球、街机欢乐捕鱼、糖果萌消消、三国大作战、欢乐的小鸟、深海探一探、王者弹珠、众神风云、福满多、斗西游、天使之战。</p>
            </div>
          </div>
