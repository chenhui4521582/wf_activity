  ...
  monopoly: {
    dropDown: {
      ...
      inner: {
        ...
        percentBg: '#dc322a',
        // packageImgs: [`${require(`./img/package/package1.png`)}`, `${require(`./img/package/package2.png`)}`, `${require(`./img/package/package3.png`)}`, `${require(`./img/package/package4.png`)}`, `${require(`./img/package/package5.png`)}`, `${require(`./img/package/package6.png`)}`],
