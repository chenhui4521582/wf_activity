<template>
  <section class="myAwards" :style="{zIndex:isShowPop?2:1}">
    <img src="../images/myAwards/icon.png" alt="" @click="showPop">
...
.myAwards {
  ...
  .pop {
    ...
    .wrap {
      width: 4.92rem;
      height: 7.8rem;
      background: url("../images/myAwards/bg.png") no-repeat center center /
        100% 100%;
      margin: 0 auto;
      ...
      .main {
        ...
        .awards-list {
          ...
          li {
            ...
            position: relative;
            &.hfq {
              background: url("../images/common/hfq-with-bg.png")
                no-repeat center center / 100% 100%;
            }
            &.jdk {
              background: url("../images/common/jdk-with-bg.png")
                no-repeat center center / 100% 100%;
              margin: 0 0.08rem;
            }
            &.yg {
              background: url("../images/common/yg-with-bg.png") no-repeat
