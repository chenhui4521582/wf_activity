  ...
  <div>
        ...
        <div class="drop-down-content">
          ...
          <div class="d-tab">
            <div style="position: absolute;width: 100%;left: 0;top: 0;">
              <ul>
                <li @click="innerHandleTab(0)" :class="{'active':curIndex == 0}">获取钥匙</li>
    ...
    <div class="bottom-wrap" v-if="!isDropDown">
      <div class="tab get-hammer" @click="outHandleTab(0)">
        ...
        <div class="right">
          <div class="main-text">剩余钥匙<span>{{remanentNum}}</span></div>
          <div class="btn">获取钥匙</div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    innerHandleTab (idx) {
      if (idx) {
        GLOBALS.marchSetsPoint('A_H5PT0075001466')   // H5平台-砸金蛋-获取钥匙大浮层-点击有奖排行榜
      } else {
        GLOBALS.marchSetsPoint('A_H5PT0075001470')   // H5平台-砸金蛋-有奖排行榜大浮层-点击获取钥匙
      }
      this.handleTab(idx)
    },
    outHandleTab (idx) {
      if (idx) {
        ...
        GLOBALS.marchSetsPoint('A_H5PT0075001464')   // H5平台-砸金蛋-点击获取钥匙
      }
      this.handleTab(idx)
    },
    handleTab (idx) {
    ...
    close () {
      ...
      if (this.curIndex) {
        ...
        GLOBALS.marchSetsPoint('A_H5PT0075001469')   // H5平台-砸金蛋-获取钥匙大浮层-点击收起
      }
      this.init()
