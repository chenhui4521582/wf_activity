    ...
    <div>
        ...
        <div class="pnl pnl_rules">
            <div class="wrapper">
                ...
                <div class="rules">
                    1. 支付1元保证金打卡，同时获得1000金叶子。<br/> 
                    2. 次日 00:00-23:59（北京时间）参与瓜分。 <br/> 
                    3. 当期挑战赛结束后，挑战成功用户可随机瓜分奖励金总额。 <br/> 
                    4. 奖励金总额随报名人数增加而扩大。 <br/> 
                    5. 活动时间：2019.12.25 - 2020.01.01
                </div>
                <div class="title title_normal">常见问题</div>
                <ul class="list_questions">
                    <li>
                        <div class="question">Q：如何完成每日打卡？</div>
                        <div class="answer">A：每日23:59前参与打卡挑战赛，用户需在次日00:00-23:59回到活动页面参与瓜分。</div>
                    </li>
                    <li>
                        <div class="question">Q：如何获得奖励金？</div>
                        <div class="answer">A：成功完成每日打卡用户，作为奖励随机瓜分本期奖励金总额（本人保证金+本期未达标用户保证金）。</div>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <div class="answer">A：若未在规定时间内未完成打卡，则挑战失败，保证金不退还，计入下期奖励金。</div>
                    </li>
                </ul>
            </div>
        </div>
