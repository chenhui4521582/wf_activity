    ...
    <div class="comPop-bc" id="cp-bc"
      ...
      <div class="title">
        ...
        <img :src="`${require(`../images/comPop/${this.popType}/title.png`)}`" alt
          style="width:1.56rem;height:0.38rem;" v-if="popType==1||popType==0" />
        <img :src="`${require(`../images/comPop/${this.popType}/title.png`)}`"
          style="width:2.77rem;height:0.38rem" v-else-if="popType==2" />
        <img :src="`${require(`../images/comPop/${this.popType}/title.png`)}`"
          style="width:2.37rem;height:0.38rem" v-else-if="popType==3" />
      </div>
      <div class="inner">
        <!-- 规则页面 -->
          ...
          <div class="everyday-container">
            ...
            <ul class="record-inner">
              <li v-for="(i,key) in list" :key="key">
                ...
                <!-- 已领取 -->
                <div v-show="lingqu[key].v" class="yilingqu">
