  ...
  <div class="second-bc">
    <div class="second-top">
      <div class="second-back">
        <img @click="back" src="../img/back.png" />
        <div class="top-text">
          <span>前30名上榜有奖</span>
        </div>
      </div>
    ...
    <div class="topthree">
      <div class="top-two">
        <div class="headpic-two">
          <img src="../img/second/testheadpic.png" alt />
        </div>
        <div class="name">
        ...
        <div class="prize-text">
          <span
            style="font-size:0.18rem;font-weight:bold;color:rgba(255,230,0,1);text-center:center;display:block">10000元</span>
          <span
            style="font-size:0.18rem;font-weight:bold;color:#F8E49B;text-center:center;display:block;">京东券</span>
          <span
            style="font-size:0.18rem;font-weight:bold;color:rgba(255,230,0,1);text-center:center;display:block;">+</span>
          <span
            style="font-size:0.18rem;font-weight:bold;text-center:center;display:block;white-space: nowrap;">
            <span style="color:#FFE600">300万</span>
            <span style="color:#FFF7A7">金叶</span>
          </span>
        </div>
        <img src="../img/second/toptwo&three.png" alt />
        <img class="two" src="../img/second/2.png" />
        <img class="prize" src="../img/second/prize.png" alt />
      </div>
      <div class="top-one">
        ...
        <div class="prize-text1">
          <span
            style="font-size:0.18rem;font-weight:bold;color:rgba(255,230,0,1);text-center:center;display:block">15000元</span>
          <span
            style="font-size:0.18rem;font-weight:bold;color:#F8E49B;text-center:center;display:block;">京东券</span>
          <span
            style="font-size:0.18rem;font-weight:bold;color:rgba(255,230,0,1);text-center:center;display:block;">+</span>
        ...
        <img src="../img/second/topone.png" alt />
        <img class="one" src="../img/second/1.png" alt />
        <img class="prize" src="../img/second/prize.png" alt />
      </div>
      <div class="top-three">
        ...
        <img src="../img/second/toptwo&three.png" alt />
        <img class="three" src="../img/second/3.png" alt />
        <img class="prize" src="../img/second/prize.png" alt />
      </div>
    </div>
    ...
    <div class="rank">
      <div class="list" v-for="(i,index) in behindTreeData ">
        <span
          style="font-size:0.24rem;font-weight:bold;color:rgba(255,224,199,1);width:0.8rem;text-align:center;">{{i.rank}}</span>
        <span
          style="font-size:0.20rem;font-weight:bold;color:rgba(255,224,199,1) ;text-align:center;position:relative;left:-0.1rem;overflow:hidden;text-overflow:ellipsis;width:1rem;white-space:nowrap;">{{i.name}}</span>
        <span style="font-size:0.20rem;font-weight:bold;color:rgba(255,224,199,1);width:1.2rem;text-align:center;position: relative;
    overflow:hidden;text-overflow:ellipsis">{{i.num}}</span>
        <span
          style="font-size:0.20rem;font-weight:bold;color:rgba(255,224,199,1);text-align:center;overflow:hidden;text-overflow:ellipsis">{{i.prize.split('+')[0]}}+<br />{{i.prize.split('+')[1]}}</span>
      </div>
      ...
      <div class="list" v-if="isOpen" v-for="(i,index) in otherData">
        <span
          style="font-size:0.24rem;font-weight:bold;color:rgba(255,224,199,1);width:0.8rem;text-align:center;">{{i.rank}}</span>
        <span
          style="font-size:0.20rem;font-weight:bold;color:rgba(255,224,199,1) ;text-align:center;position:relative;left:-0.1rem;width:1rem;white-space:nowrap;overflow:hidden;">{{i.name}}</span>
        <span style="font-size:0.20rem;font-weight:bold;color:rgba(255,224,199,1);width:1.2rem;text-align:center;position: relative;
overflow:hidden;text-overflow:ellipsis">{{i.num}}</span>
        <span
          style="font-size:0.20rem;font-weight:bold;color:rgba(255,224,199,1);text-align:center;overflow:hidden;text-overflow:ellipsis">{{i.prize.split('+')[0]}}+<br />{{i.prize.split('+')[1]}}</span>
