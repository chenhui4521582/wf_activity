  ...
  <div class="get-hammer">
    <template
      ...
      <template v-if="indextitle==0">
        <span class="info">{{$moduleConfig.superLotto.dropDown.inner.info.sideTitle}}<br><i>累计消耗{{actInfoData.bettingRate|filterPrice}}金叶=1个荷灯</i></span>
        <div class="g-package"
          ...
          <div class="g-package-info">
            <ul class="li0">
              <li>今日获得荷灯：{{actInfoData.todayGameAmount}}</li>
            </ul>
          </div>
        </div>
      </template>
      <template v-else>
        <div class="g-package"
          ...
          <div class="g-package-info">
            <ul class="li0">
              <li>今日获得荷灯：{{actInfoData.todayBagAmount}}</li>
            </ul>
          </div>
        </div>
      </template>
