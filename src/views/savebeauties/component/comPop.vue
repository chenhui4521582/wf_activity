              ...
              <template v-else-if="popType==7">
                <scroll>
                  <div>
                    ...
                    <p>玩法：</p>
                    <p>每日营救：</p>
                    <p>1、活动共计六天，玩家需要每天营救一名同伴。活动累计可救出六名同伴。</p>
                    <p>2、每天会更新五个不同的任务，玩家通过完成每个任务可以解锁对应的拼图碎片及任务奖励，完成全部任务即视为营救成功，并获得每日拼图加奖。</p>
                    <p>3、当玩家觉得部分任务太难，可以有两个方案降低任务难度。（活动道具每天仅可购买一次且当日有效）</p>
                    <p>• 购买万能碎片礼包：万能碎片购买成功后可以解锁任意一块未解锁的拼图碎片。</p>
                    <p>• 付费重置任务：购买付费重置任务可将所有未完成的任务难度降级，加速完成任务。（已完成的任务不会被重置，完成中的任务进度将被清零）</p>
                    <p>4、每日营救当天未完成五个任务则视为放弃当前同伴，第二天开启全新营救任务。</p>
                    <p>5、同伴每天零点刷新，同时开启新的每日营救任务。</p>
                    <p>我的队伍：</p>
                    <p>当玩家救出三名同伴，可得三人奖励；当玩家救出六名同伴，则完成本次活动，并获得终极奖励。</p>
                    <p>活动期间内，获得的奖励需当天领取，逾期作废。</p>
