      ...
      <div class="toppart">
        <div class="content">
          ...
          <div class="form-groups" v-if="currentIndex==1">
            ...
            <div class="group-input group-input1">
              <div class="input-box group-line">
                <input v-if="eyeclose" type="password" placeholder="请输入密码" v-model="vCode" maxlength="16">
                <input v-else type="text" placeholder="请输入密码" v-model="vCode" maxlength="16">
...
export default {
  ...
  beforeMount () {
    let isBind = localStorage.getItem('isBinding') !== 'false'
    this.showPage = true
  },
  mounted () {
...
.content {
  ...
  .selection-ways {
    width: 100%;
    height: 1.8/2rem;
    padding: 0.62/2rem 1rem 0 0.11rem;
    display: flex;
    justify-content: space-around;
    font-size: 0.56/2rem;
    font-family: PingFangSC-Regular;
    color: #000;
    box-shadow: 0 0.4/2rem 0.4/2rem #ff000000;
    .selected {
      position: relative;
