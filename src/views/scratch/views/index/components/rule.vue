<template>
  <div class="rule" v-if="value">
    ...
    <div class="center">
      ...
      <div class="wrap">
          活动时间：{{info.beginDate | formatTime('y:m:d h:m:s')}} - {{info.endDate | formatTime('y:m:d h:m:s')}} <br>
          ...
          <a @click="openBetAward">点击查看奖励</a> <br>
          5. 活动结束后，根据活动期间累计获得的游戏币进行排名并发放排行奖励，有奖排行榜仅限前30名玩家进榜，排行榜奖励将直接发放，排行榜单会展示一天 注意：<br>
           活动结束后，未使用的游戏币将清零 活动结束后，未使用的刮刮卡作废
      </div>
