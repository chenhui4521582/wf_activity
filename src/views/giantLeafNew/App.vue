<template>
  <div class="giant-leaf-container">
    ...
    <rule :showRule="showRule" @hideRule="hideRule" />
    <turntable-dialog :priceData="priceData" :showDialog="showDialog" :dialogStatus="dialogStatus" @hideDialog="hideDialog" @going="going" />
  </div>
</template>
...
.fh-box {
  ...
  .btn {
    ...
    height: 0.58rem;
    line-height: 0.58rem;
    background: rgba(14, 199, 197, 0.61);
