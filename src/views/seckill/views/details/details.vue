<template>
  <div class="details">
    ...
    <!-- 没有库存Modal -->
    <modal
      v-model="noAwardModal"
      title="温馨提示" 
      :type="2"
      closeText="看看其他活动"
      saveText="看看别的秒杀"
      @on-close="modalClose"
      @on-save="modalConfirm"
    >
    ...
    >
     <div class="logisticsModal">
        <p>因全力做好配合疫情防控工作，原定2月3日恢复发货延期至2月10日陆续发货（适用于大部分商品，纸品、小家电发货时间待定）。</p>
        <p>快递发出后因部分地区自发性封路将导致派件异常无法上门，请您理解。</p>
        <p>感谢您等待，如有任何疑问，请及时联系在线客服。</p>
        <p>注意：如果疫情继续恶化，发货时间会根据实际情况做出调整，届时将发布新的通知，请及时关注。</p>
      </div>
    </modal>
  </div>
</template>
