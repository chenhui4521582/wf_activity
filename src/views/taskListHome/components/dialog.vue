<template>
  <main>
    <div class="mask"></div>
    <img class="shine"
      src="../images/dialog/shine.png"
      alt="">
    <div class="content-box">
      <img class="bg"
        src="../images/dialog/bg.png">
      <div class="content">
        <img class="title"
          src="../images/dialog/congratulations-text.png"
          alt="">
        <!-- 糖果勋章 -->
        <div v-if="showMedelPop"
          class="crush-wrap">
          <img class="medeal-icon"
            :src="receiveData.medalimg | filter">
        </div>
        <div v-else>
          <div class="common-wrap">
            <img class="hb-icon"
              src="../images/dialog/leaf.png"
              alt="">
          </div>
