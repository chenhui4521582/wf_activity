...
<style rel="stylesheet/less" lang="less" scoped>
    ...
    .content-box {
        ...
        .top-envo {
            ...
            -webkit-animation: top-envolope .5s 1 forwards;
            -webkit-animation-delay: .5s;
            ...
            &:after{
                ...
                background-size: 100% 100%;
                opacity: 1;
                -webkit-animation: opacitychangecoin .5s 1 forwards;
                -webkit-animation-delay: .5s;
            }
        }
        ...
        .close {
            ...
            width: 0.6rem;
            height: 0.6rem;
            background: url("../images/bonus/close.png") no-repeat center /
      100% 100%;
        }
    }
