...
export const sign = async () => {
  ...
  const { data } = { data: { 'code': 200, 'data': { 'signInRsps': [{ 'day': 1, 'date': null, 'status': 2, 'awardName': '100金叶子', 'curDay': false }, { 'day': 2, 'date': null, 'status': 2, 'awardName': '1000金叶子', 'curDay': true }, { 'day': 3, 'date': null, 'status': 0, 'awardName': '100金叶子', 'curDay': false }, { 'day': 4, 'date': null, 'status': 0, 'awardName': '1000金叶子', 'curDay': false }, { 'day': 5, 'date': null, 'status': 0, 'awardName': '1000金叶子', 'curDay': false }], 'awardRsp': { 'awardName': '捕鱼游戏道具', 'awardNum': 1, 'awardImg': '' } }, 'message': null } }
  return data
}
/**
 * @description 任务领取
