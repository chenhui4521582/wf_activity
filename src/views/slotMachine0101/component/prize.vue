<template>
  <div class="prize">
    <div class="prize_container">
      <div class="prize_big">
        <div class="prize_list" v-for="(i,key) in list" :key="key" >
          <div class="prize_inner" v-html="i.text"></div>
          <div class="prize_btn" :style="{background:i.btnColor}" @click="look(key)" >{{i.btnText}}</div>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods:{
      look:function(key){ 
          ...
          console.log(this.list[key].id)
       
          
          
          this.$emit('openprize',this.prizeshow,this.list[key].id)
         
        //   console.log(this.prizeshow)
        //   if(this.prizeshow==false){
        //       this.prizeshow=true
        //   }else{
...
.prize {
  ...
  .prize_container {
    ...
    width: 6.7rem;
    height: 4.07rem;
    background: url("../images/prizebackground.png");
