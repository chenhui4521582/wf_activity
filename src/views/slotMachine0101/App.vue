<template>
  <div class="big" :class="{noshowrank:!showRank}">
    <template v-if="actData">
      ...
      <drop-down ref="dropDown" :rules-explain="time" v-if="!showRank" :my-info="userData"
        @refresh="refresh"></drop-down>
      <com-pop :pop-type="popType" :prize-info-type="prizeInfoType"
        ...
        @close="popType=0" @gotowavedirect="gotowavedirect"></com-pop>
    </template>
