...
export default {
  ...
  mounted() {
    ...
    this.gameType = localStorage.getItem('wj_gameType') ? localStorage.getItem('wj_gameType'):this.getUrlParam('gameType')
  ...
  methods: {
    ...
    getPlatTaskByBatch() {
      this.axios.post('//platform-api.beeplay123.com/task/api/usertask/platTaskByBatch', {
        value: this.gameType+"-achievementTask",
        from: "sdk",
