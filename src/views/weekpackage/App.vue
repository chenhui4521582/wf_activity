<template>
  <div id="app">
    ...
    <!--以下都是弹窗-->
    <pop v-if="flag" :type="flag" :detail="detailData" :finalAwards="finalAwards" @close="closepop"></pop>
  </div>
</template>
<script>
    ...
    .turntable-btn {
      ...
      &.enable {
        ...
        .turn-countdown {
          top: 1.4rem;
          color: #fff;
          -webkit-text-stroke: .02rem #CA5C2C;
        }
      }
      ...
      &.disabled {
        .turn-countdown {
          color: #fff;
          -webkit-text-stroke: .02rem rgba(108,108,108,0.6);
        }
      }
