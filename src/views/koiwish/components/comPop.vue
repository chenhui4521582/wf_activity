              ...
              <template v-if="popType==1">
                <scroll>
                  <div>
                    ...
                    <p>3、许愿池分为至尊池、黄金池，每种许愿池各有3种锦鲤大奖，各设{{totalRound}}次锦鲤开奖机会（蓄满奖池后600秒抽锦鲤结束后，即为1场结束）；</p>
                    <p class="highlight">4、单场累计许愿送奖励</p>
                    <p>单个场次奖池积蓄许愿珠时，玩家消耗许愿珠向奖池许愿，达到一定数量即可解锁奖品，玩家可到【领奖】页手动领取；</p>
                    <p class="highlight">5、许愿池开启，中锦鲤大奖</p>
                    <p>①许愿池积满一定许愿珠时（至尊池积满150000珠，黄金池积满50000珠），奖池开启600秒倒计时，在此期间许愿有机率赢锦鲤大奖。</p>
                    ...
                    <p>6、场次结束</p>
                    <p>①每种许愿池共有{{totalRound}}场。每场开奖后，下一场开始，<span class="white">上一场的累计消耗许愿珠归零，许愿池从0累计许愿珠；</span></p>
                    <p>②任一许愿池在<span class="highlight">第{{totalRound}}场开奖后即为结束</span>；两种许愿池均结束后，活动结束，且剩余许愿珠作废；</p>
                    <p>7、金叶消耗计入活动的游戏包括：糖果萌消消、街机欢乐捕鱼、疯狂炸弹人、三国大作战、欢乐竞技台球、众神风云、破晓方块消消乐、斗西游、王者弹珠、欢乐的小鸟、天使之战。</p>
                  </div>
                </scroll>
              </template>
              <template v-else-if="popType==2">
                <scroll>
                  <div>
                    ...
                    <p class="white">注：抽锦鲤期间许愿消耗的许愿珠，不计入【当前场次累计消耗许愿珠】，不可额外解锁奖品</p>
                    <p>4、每种许愿池共有{{totalRound}}场。每场开奖后，下一场开始，上场累计消耗许愿珠归零，许愿池从0累计许愿珠 </p>
                    <p>5、当至尊、黄金池{{totalRound}}场开奖均结束后，活动结束。 </p>
                    <p>具体可见活动规则</p>
                  </div>
                </scroll>
              </template>
