<template>
  <div class="pop-log">
    ...
    <template v-else>
      <task-award-pop v-if="awardItemNew.awardsName" :awards="awardItemNew" :awardsImage="awardsImage"
                      :btnName="btnName" @close="close"></task-award-pop>
    </template>
  </div>
</template>
<script type="text/javascript">
  export default {
    ...
    computed: {
      awardsImage() {
        let url = this.awardItem.awardsImage
        if (this.masterTask) {
          if (this.awardItem.showMedalImg) {
