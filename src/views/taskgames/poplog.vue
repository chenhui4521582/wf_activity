<template>
  <div class="pop-log">
    ...
    <div class="content-box new" v-else>
        ...
        <div class="content" v-if="!(newTaskItems&&newTaskItems.popUp)">
          ...
          <div class="text progress" v-if="isNewTask && motherTask">
            ...
            <div class="progress-bg">
              <div class="progress-bar" :style="{width:motherTask.hasFinishedNum/motherTask.allTaskNum * 100 + '%'}"></div><span>{{motherTask.hasFinishedNum}}/{{motherTask.allTaskNum}}</span>
            </div>
          </div>
          <div class="close" @click="close">朕收下了</div>
        </div>
      ...
      <div v-else>
        <div class="content">
          <img v-if="motherTask.awardsNum === 15" src="./img/gettitle_1.5.png" alt="" class="title">
          <img v-else-if="motherTask.awardsNum === 30" src="./img/gettitle_3.png" alt="" class="title">
          <img v-else src="./img/toast_title.png" alt="" class="title">
          <img src="./img/signIn-icon.png" alt="" class="price">
          <div class="num">{{motherTask.awardsName}}</div>
