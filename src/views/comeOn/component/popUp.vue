          ...
          <div class="container">
            ...
            <template v-if="type===1">
              <p class="text">
                ...
                活动介绍：<br />
                1、活动期间，玩家通过在指定游戏中（糖果萌消消、街机欢乐捕鱼、疯狂炸弹人、三国大作战、欢乐竞技台球、众神风云、破晓方块消消乐、斗西游、王者弹珠、欢乐的小鸟、天使之战）消耗金叶子来获得加油次数，领取奖励。<br />
                2、活动共设置4层关卡，玩家需逐层进行挑战；如果4层全部通关，玩家会返回第一层循环挑战。<br />
                3、活动结束后按照加油次数排名，前100名获得奖励。排行榜内若加油次数数量一致，则先完成的玩家排名靠前。<br />
                4、排行榜在活动结束后多展示一天。<br />
            ...
            <template v-if="type===3 || type===4 || type===5">
              ...
              <p class="red-text">
                ...
                <template v-if="type===5">
                  ...
                  <template v-else>
                    已加油{{awardInfo.thisFinishNum}}次<br>
                  </template>
                  获得
                </template>
              </p>
      ...
      .award-list {
        ...
        li {
          ...
          &.list-head {
            color: #fff;
            background: #e6aa85;
            border-bottom: 0.03rem solid #e6aa85;
            padding: 0.02rem 0;
