    ...
    <section class="after" id="after">
      ...
      <div class="container1" v-if="myInfo">
        ...
        <div class="container1_container">
          <template v-if="tabIndex==0">
            <div class="packgaes">
              <div class="item" v-for="(item,index) in taskInfo">
                ...
                <template v-else>
                  <div class="btn-all" @click="gotopay(item,item.buyFlag != 0)" :class="{gray:item.buyFlag == 0}">
                    {{item.price}}元全部抢购
                  </div>
                </template>
              </div>
          ...
          <template v-else>
            <div class="awards" v-if="coinInfo&&coinInfo.limitedTimePackageExchangeAwardsList.length">
              <div class="item" v-for="(item,index) in coinInfo.limitedTimePackageExchangeAwardsList"
                ...
                <div class="btn" @click="gain(item)"><img src="./images/jinbi.png" alt="">x{{item.costCoin}}</div>
              </div>
            </div>
          </template>
          <p
      ...
      <common-package-pop :is-show-pop="isShowPackagePop" :fail="fail" :awardData="awardPackageData"
                          @close-pop="isShowPackagePop=false" @gototask="gototask"
                          @exchange="exchange"></common-package-pop>
