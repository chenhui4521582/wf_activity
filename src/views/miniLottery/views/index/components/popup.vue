  ...
  <div class="popup" v-if="value">
    ...
    <div class="container">
      ...
      <div class="rule" v-if="popupStatus == 1">
        <div class="title"></div>
        <div class="center">
          1. 天天夺宝是为感谢广大玩家一直以来对我们的支持和厚爱推出的回馈送福利活动。
          2. 夺宝参与方式：使用话费券换取“夺宝码”（在夺宝记录中查看）。每期夺宝码从100001起递增，每投入1次，号码递增1位，达到开奖条件后，系统会从已产生的夺宝码中随机抽取1给成为本期“幸运码”，持有与幸运码匹配号码用户获得当期奖励！投入越多，中奖机会越大哟！
          3. 夺宝开奖方式：达到指定的开奖时间即可开奖。需注意：若本期未达到最低的夺宝次数，则本期奖品流拍，已投入的话费券将自动返还
          4. 平台保证夺宝抽奖绝对公平公正。
        </div>
