...
export const finish = async (params) => {
  const { data } = await $axios.post(`${PLATFORM_API_BASE_URL}/task/api/usertask/finish`, params)
  // const data = { 'code': 200, 'data': { 'awardsName': '幸运大转盘拉新-1次转盘机会', 'awardsImage': '/group1/M00/43/4F/CmcEHV6zqjyAdqjOAAAHAqalI8w239.png', 'showAwardsImage': '/group1/M00/43/4F/CmcEHV6zqkWABULsAAAHAqalI8w203.png', 'awardsNum': 1 }, 'message': null }
  return data
}
const Service = {
  activityInfo,
