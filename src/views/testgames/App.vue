...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            createurl(url){
                return `https://wap.beeplay123.com/activities/wfgames.html?channel=100037&extgameurl=${base64url.encode(url)}`
            }
        },
        mounted(){
        },
